...
We aim to respond to all inquiries within 48 hours.`
  ...
  return (
    <div className="min-h-screen section-light py-16">
      <div className="container">
        ...
        >
          <h1 className="text-4xl font-bold text-center mb-4 text-heading">Privacy Policy</h1>
          ...
          <div className="card p-8">
            <div className="space-y-8">
              {sections.map((section, index) => (
                ...
                >
                  <h2 className="text-2xl font-semibold mb-4 text-heading">{section.title}</h2>
