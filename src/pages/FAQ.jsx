  ...
  return (
    <div className="min-h-screen section-light py-16">
      <div className="container">
        ...
        >
          <h1 className="text-4xl font-bold text-center mb-4 text-heading">Frequently Asked Questions</h1>
          ...
          <div className="space-y-8">
            {faqSections.map((section, sectionIndex) => (
              <div key={sectionIndex} className="card">
                <h2 className="text-xl font-semibold p-6 bg-secondary-50 dark:bg-secondary-700 text-heading">
                  {section.title}
                </h2>
