...
export const Overlay = () => {
  ...
  return (
    <>
      <div
        className={`fixed z-10 top-0 left-0 bottom-0 right-0 flex flex-col justify-between pointer-events-none text-heading ${
          visible ? "" : "opacity-0"
      ...
      >
        <Link to='/' className="flex items-center justify-center mx-auto mt-8">
          ...
          <span className="text-2xl icon-primary font-bold mt-1.5">BestCity</span>
        </Link>
        <div className="bg-gradient-to-t from-white/90 dark:from-secondary-900/90 pt-20 pb-10 p-4 flex items-center flex-col text-center">
          <h1 className="text-2xl lg:text-5xl font-extrabold text-heading">
            {scenes[displaySlide].name}
          </h1>
          <p className="text-xs lg:text-sm text-body italic">
            {scenes[displaySlide].description}
          </p>
          <div className="flex items-center gap-12 mt-4">
            <div className="flex flex-col items-center">
              <div className="flex items-center gap-2">
                <p className="font-semibold text-sm lg:text-2xl text-heading">
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-xs text-muted">Valuation</p>
            </div>
          </div>
